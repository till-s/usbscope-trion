...
# PLL Constraints
#################
create_clock -period 6.0606 sdram_smpl_clk
create_clock -period 20.0000 rmii_clk
create_clock -period 16.6667 ulpiClk
create_clock -period 8.3333 adcClk
create_clock -period 6.0606 sdram_clk
...
# set_input_delay -clock <CLOCK> [-reference_pin <clkout_pad>] -max <MAX CALCULATION> [get_ports {spiCSb_IN}]
# set_input_delay -clock <CLOCK> [-reference_pin <clkout_pad>] -min <MIN CALCULATION> [get_ports {spiCSb_IN}]
# set_output_delay -clock <CLOCK> [-reference_pin <clkout_pad>] -max <MAX CALCULATION> [get_ports {spiCSb_OUT}]
# set_output_delay -clock <CLOCK> [-reference_pin <clkout_pad>] -min <MIN CALCULATION> [get_ports {spiCSb_OUT}]
# set_output_delay -clock <CLOCK> [-reference_pin <clkout_pad>] -max <MAX CALCULATION> [get_ports {spiCSb_OE}]
# set_output_delay -clock <CLOCK> [-reference_pin <clkout_pad>] -min <MIN CALCULATION> [get_ports {spiCSb_OE}]
...
############################
set_input_delay -clock rmii_clk -reference_pin [get_ports {rmii_clk~CLKOUT~143~1}] -max 0.790 [get_ports {eth_crs_dv}]
set_input_delay -clock rmii_clk -reference_pin [get_ports {rmii_clk~CLKOUT~143~1}] -min 0.395 [get_ports {eth_crs_dv}]
set_input_delay -clock rmii_clk -reference_pin [get_ports {rmii_clk~CLKOUT~132~1}] -max 0.790 [get_ports {eth_rx_col}]
set_input_delay -clock rmii_clk -reference_pin [get_ports {rmii_clk~CLKOUT~132~1}] -min 0.395 [get_ports {eth_rx_col}]
set_input_delay -clock rmii_clk -reference_pin [get_ports {rmii_clk~CLKOUT~142~1}] -max 0.790 [get_ports {eth_rx_dv}]
set_input_delay -clock rmii_clk -reference_pin [get_ports {rmii_clk~CLKOUT~142~1}] -min 0.395 [get_ports {eth_rx_dv}]
set_input_delay -clock rmii_clk -reference_pin [get_ports {rmii_clk~CLKOUT~133~1}] -max 0.790 [get_ports {eth_rx_err}]
set_input_delay -clock rmii_clk -reference_pin [get_ports {rmii_clk~CLKOUT~133~1}] -min 0.395 [get_ports {eth_rx_err}]
set_input_delay -clock rmii_clk -reference_pin [get_ports {rmii_clk~CLKOUT~98~1}] -max 0.790 [get_ports {eth_rxd[0]}]
set_input_delay -clock rmii_clk -reference_pin [get_ports {rmii_clk~CLKOUT~98~1}] -min 0.395 [get_ports {eth_rxd[0]}]
set_input_delay -clock rmii_clk -reference_pin [get_ports {rmii_clk~CLKOUT~97~1}] -max 0.790 [get_ports {eth_rxd[1]}]
set_input_delay -clock rmii_clk -reference_pin [get_ports {rmii_clk~CLKOUT~97~1}] -min 0.395 [get_ports {eth_rxd[1]}]
set_input_delay -clock rmii_clk -reference_pin [get_ports {rmii_clk~CLKOUT~118~1}] -max 0.790 [get_ports {eth_rxd[2]}]
set_input_delay -clock rmii_clk -reference_pin [get_ports {rmii_clk~CLKOUT~118~1}] -min 0.395 [get_ports {eth_rxd[2]}]
set_input_delay -clock rmii_clk -reference_pin [get_ports {rmii_clk~CLKOUT~117~1}] -max 0.790 [get_ports {eth_rxd[3]}]
set_input_delay -clock rmii_clk -reference_pin [get_ports {rmii_clk~CLKOUT~117~1}] -min 0.395 [get_ports {eth_rxd[3]}]
set_output_delay -clock rmii_clk -reference_pin [get_ports {rmii_clk~CLKOUT~91~1}] -max 0.100 [get_ports {eth_tx_en}]
set_output_delay -clock rmii_clk -reference_pin [get_ports {rmii_clk~CLKOUT~91~1}] -min -0.175 [get_ports {eth_tx_en}]
set_output_delay -clock rmii_clk -reference_pin [get_ports {rmii_clk~CLKOUT~90~1}] -max 0.100 [get_ports {eth_txd[0]}]
set_output_delay -clock rmii_clk -reference_pin [get_ports {rmii_clk~CLKOUT~90~1}] -min -0.175 [get_ports {eth_txd[0]}]
set_output_delay -clock rmii_clk -reference_pin [get_ports {rmii_clk~CLKOUT~81~1}] -max 0.100 [get_ports {eth_txd[1]}]
set_output_delay -clock rmii_clk -reference_pin [get_ports {rmii_clk~CLKOUT~81~1}] -min -0.175 [get_ports {eth_txd[1]}]
set_output_delay -clock rmii_clk -reference_pin [get_ports {rmii_clk~CLKOUT~80~1}] -max 0.100 [get_ports {eth_txd[2]}]
set_output_delay -clock rmii_clk -reference_pin [get_ports {rmii_clk~CLKOUT~80~1}] -min -0.175 [get_ports {eth_txd[2]}]
...
############################
# set_output_delay -clock <CLOCK> [-reference_pin <clkout_pad>] -max <MAX CALCULATION> [get_ports {eth_mdc}]
# set_output_delay -clock <CLOCK> [-reference_pin <clkout_pad>] -min <MIN CALCULATION> [get_ports {eth_mdc}]
# set_output_delay -clock <CLOCK> [-reference_pin <clkout_pad>] -max <MAX CALCULATION> [get_ports {eth_rstb}]
# set_output_delay -clock <CLOCK> [-reference_pin <clkout_pad>] -min <MIN CALCULATION> [get_ports {eth_rstb}]
set_output_delay -clock rmii_clk -reference_pin [get_ports {rmii_clk~CLKOUT~71~1}] -max 0.100 [get_ports {eth_txd[3]}]
set_output_delay -clock rmii_clk -reference_pin [get_ports {rmii_clk~CLKOUT~71~1}] -min -0.175 [get_ports {eth_txd[3]}]
# set_input_delay -clock <CLOCK> [-reference_pin <clkout_pad>] -max <MAX CALCULATION> [get_ports {eth_mdio_IN}]
# set_input_delay -clock <CLOCK> [-reference_pin <clkout_pad>] -min <MIN CALCULATION> [get_ports {eth_mdio_IN}]
# set_output_delay -clock <CLOCK> [-reference_pin <clkout_pad>] -max <MAX CALCULATION> [get_ports {eth_mdio_OUT}]
# set_output_delay -clock <CLOCK> [-reference_pin <clkout_pad>] -min <MIN CALCULATION> [get_ports {eth_mdio_OUT}]
# set_output_delay -clock <CLOCK> [-reference_pin <clkout_pad>] -max <MAX CALCULATION> [get_ports {eth_mdio_OE}]
# set_output_delay -clock <CLOCK> [-reference_pin <clkout_pad>] -min <MIN CALCULATION> [get_ports {eth_mdio_OE}]
# set_input_delay -clock <CLOCK> [-reference_pin <clkout_pad>] -max <MAX CALCULATION> [get_ports {eth_pwrdwn_irq_IN}]
# set_input_delay -clock <CLOCK> [-reference_pin <clkout_pad>] -min <MIN CALCULATION> [get_ports {eth_pwrdwn_irq_IN}]
# set_output_delay -clock <CLOCK> [-reference_pin <clkout_pad>] -max <MAX CALCULATION> [get_ports {eth_pwrdwn_irq_OUT}]
# set_output_delay -clock <CLOCK> [-reference_pin <clkout_pad>] -min <MIN CALCULATION> [get_ports {eth_pwrdwn_irq_OUT}]
# set_output_delay -clock <CLOCK> [-reference_pin <clkout_pad>] -max <MAX CALCULATION> [get_ports {eth_pwrdwn_irq_OE}]
# set_output_delay -clock <CLOCK> [-reference_pin <clkout_pad>] -min <MIN CALCULATION> [get_ports {eth_pwrdwn_irq_OE}]
...
############################
# set_clock_latency -source -setup <board_max -4.110> [get_ports {sdram_smpl_clk}]
# set_clock_latency -source -hold <board_min -2.055> [get_ports {sdram_smpl_clk}]
# set_clock_latency -source -setup <board_max -4.110> [get_ports {rmii_clk}]
# set_clock_latency -source -hold <board_min -2.055> [get_ports {rmii_clk}]
